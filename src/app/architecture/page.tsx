...
export default function ArchitecturePage() {
  return (
    <main className="max-w-4xl mx-auto px-6 py-24 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out">
      <section className="space-y-16">
        ...
        <div className="p-8 rounded-2xl bg-white/40 dark:bg-zinc-900/40 backdrop-blur-md border border-brand-accent/20 shadow-sm">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6">
            ...
            <div className="flex flex-col items-center gap-2 w-40 text-center">
              ...
              <span className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Client / Browser</span>
            ...
            <div className="flex flex-col items-center gap-2 w-40 text-center">
              ...
              <span className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Next.js Edge</span>
            ...
            <div className="flex flex-col items-center gap-2 w-40 text-center">
              ...
              <span className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">Server Actions</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border border-brand-accent/20 rounded-xl shadow-sm transition-colors duration-300 hover:border-brand-accent/40">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm">
              The Recruit Me feature utilizes a custom semantic parsing algorithm. It safely evaluates user-submitted job descriptions against a strict dimensional array of my verified stack using Server Actions.
            </p>
          </div>
          ...
          <div className="p-6 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border border-brand-accent/20 rounded-xl shadow-sm transition-colors duration-300 hover:border-brand-accent/40">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm">
              Instead of traditional REST endpoints, backend requests are handled securely via Next.js <strong>Server Actions</strong> (<code>useActionState</code>). This allows form data to be safely validated without exposing manual API routes to the public.
            </p>
          </div>
          ...
          <div className="p-6 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border border-brand-accent/20 rounded-xl shadow-sm transition-colors duration-300 hover:border-brand-accent/40">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm">
              ...
              codebase is strictly typed with TypeScript to eliminate runtime errors.
            </p>
          </div>
          ...
          <div className="p-6 bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md border border-brand-accent/20 rounded-xl shadow-sm transition-colors duration-300 hover:border-brand-accent/40">
            ...
            <p className="text-zinc-600 dark:text-zinc-400 leading-relaxed text-sm">
              React hooks (<code>useState</code>, <code>useRef</code>, <code>useFormStatus</code>) are used surgically only in Client Components (like the video player and matcher), keeping the global bundle exceptionally lightweight.
            </p>
          </div>
